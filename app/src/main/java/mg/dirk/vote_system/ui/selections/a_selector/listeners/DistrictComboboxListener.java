...
public class DistrictComboboxListener implements ItemListener {
    ...
    public DistrictComboboxListener(ASelector aSelector) {
        super();
    ...
    public void itemStateChanged(ItemEvent e) {
        ...
        if (e.getStateChange() == ItemEvent.SELECTED && item instanceof District) {
            this.getASelector().setSelectedDistrict((District) item);
        }
    }
}
